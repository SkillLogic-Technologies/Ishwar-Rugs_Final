...
export const SocialCard = ({
  title = "Follow Us",
  socialLinks = [
    { href: "https://instagram.com", icon: <InstagramIcon />, className: "box1" },
    { href: "https://twitter.com", icon: <TwitterIcon />, className: "box2" },
    { href: "https://discord.com", icon: <DiscordIcon />, className: "box3" },
  ],
}: SocialCardProps) => (
  <div className="card">
